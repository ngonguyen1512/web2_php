<?php 
    ...
    $result = mysqli_query($con, "SELECT * FROM `product` WHERE `mabrand` = 'LB'");
    mysqli_close($con);
...
<div class="sideleft">
    <ul class="side_main">
        <li >
            <form method="POST" action="index.php?quanly=sanpham&quanly=lb&quanly=searchwsp" >
...
<h1>LEBRON</h1>
    ...
    <?php 
        while($row = mysqli_fetch_array($result)){   
            echo '<li><a href = "index.php?quanly=sanpham&quanly=lb&quanly=ctsp&idsp='.$row['idsp'].'">';
