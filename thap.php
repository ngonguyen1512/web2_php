<?php 
    ...
    $result = mysqli_query($con, "SELECT * FROM `product` WHERE `dongia` < '4000000'");
    mysqli_close($con);
...
<div class="sideleft">
    <ul class="side_main">
        <li >
            <form method="POST" action="index.php?quanly=sanpham&quanly=thap&quanly=searchwsp" >
...
<div class="mainsp">
    <h1>Dưới 4,000,000 đ</h1>
    <ul class="productsp">
    <?php 
        while($row = mysqli_fetch_array($result)){   
            echo '<li><a href = "index.php?quanly=sanpham&quanly=thap&quanly=ctsp&idsp='.$row['idsp'].'">';
