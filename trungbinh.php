<?php 
    ...
    $result = mysqli_query($con, "SELECT * FROM `product` WHERE `dongia` >= '4000000' AND `dongia` < '10000000'");
    mysqli_close($con);  
?>
<div class="sideleft">
    <ul class="side_main">
        <li >
            <form method="POST" action="index.php?quanly=sanpham&quanly=trungbinh&quanly=searchwsp" >
...
<div class="mainsp">
    <h1>4,000,000 đ - 10,000,000 đ</h1>
    <ul class="productsp">
    <?php 
        while($row = mysqli_fetch_array($result)){   
            echo '<li><a href = "index.php?quanly=sanpham&quanly=trungbinh&quanly=ctsp&idsp='.$row['idsp'].'">';
