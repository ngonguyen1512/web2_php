<?php 
    ...
    $result = mysqli_query($con, "SELECT * FROM `product` WHERE `mabrand` = 'AF'");
    mysqli_close($con);
...
<div class="sideleft">
    <ul class="side_main">
        <li >
            <form method="POST" action="index.php?quanly=sanpham&quanly=af&quanly=searchwsp" >
...
<h1>AIR FORCE 1</h1>
    ...
    <?php 
        while($row = mysqli_fetch_array($result)){   
            echo '<li><a href = "index.php?quanly=sanpham&quanly=af&quanly=ctsp&idsp='.$row['idsp'].'">';
