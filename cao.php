<?php 
    ...
    $result = mysqli_query($con, "SELECT * FROM `product` WHERE `dongia` > '10000000'");
    mysqli_close($con);
...
<div class="sideleft">
    <ul class="side_main">
        <li >
            <form method="POST" action="index.php?quanly=sanpham&quanly=cao&quanly=searchwsp" >
...
<div class="mainsp">
<h1>TRÊN 10,000,000 Đ</h1>
    <ul class="productsp">
    <?php 
        while($row = mysqli_fetch_array($result)){   
            echo '<li><a href = "index.php?quanly=sanpham&quanly=cao&quanly=ctsp&idsp='.$row['idsp'].'">';
