...
<?php while ($row = mysqli_fetch_array($result)){ 
    ...
    <form method="POST" action="index.php?quanly=sanpham&quanly=chitietsp&quanly=themgiohang&idsp=<?php echo $_GET['idsp']?>">
        <table>
            <tr>
                <td rowspan="8" style="width:60%; hegiht: 20%;text-align:center"><img src = "<?php echo $row['hinhanh'] ?>"></td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2" class="mota"><?php echo $row['mota']?></td>
            </tr>
            <tr>
            ...
            <!-- <tr>
                <td  colspan="2" class="size"> Size: 
                    <input type="radio" name="size"><label>38</label>
                    <input type="radio" name="size"><label>39</label>
                    <input type="radio" name="size"><label>40</label>
                </td>
            </tr> -->
            <tr>
                <td  colspan="2" class="soluong">
                    <!-- <input type="number" id="quantity" name="quantity"/> -->
                    <!-- <input style="font-size:22px;width:8%; " onclick=" clickgiam()" type='button' value='-' > -->
                    <input min="1" name='quantity' type='number' value='1' style="width:20%;font-size:20px; text-align:center; margin: 0 1% 0 1%">
